...
### مستخدمي iOS (iPhone/iPad)
لأنظمة iOS، يمكنك تشغيل التطبيق مباشرة كـ **Web App** عبر الرابط التالي (يفضل فتحه باستخدام متصفح Safari):
🔗 [رابط تشغيل التطبيق للايفون](https://srfalah.github.io/tarmiz_community_app/)

### مستخدمي Android
لمستخدمي الأندرويد، يمكنكم تحميل ملف الـ **APK** مباشرة وتثبيته على أجهزتكم من خلال قسم الإصدارات releases
...
---
## ملاحظة
- شكل التطبيق بعد تثبيته وتشغيله على جهاز أندرويد سيكون أفضل مما يظهر في الصور أدناه.
---
## صور من التطبيق
